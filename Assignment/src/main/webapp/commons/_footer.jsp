		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-12">
					...
					<p class="mb-3">
						<i class="bi-geo-alt me-2"></i> London, United Kingdom
					</p>

					<p class="mb-2">
						<a href="tel: 010-020-0340" class="contact-link"> 010-020-0340
						</a>
					</p>
					...
					<p class="copyright-text">
						...
						<br>
						<a rel="nofollow" href="https://templatemo.com" target="_blank">designed
							by templatemo</a>
					</p>
				</div>
